    ...
    return (
        <div className='h-fit w-3/4 py-4 mt-20 '>
            <div className=' h-full w-full md:w-1/2'>
                ...
                <h1 className='mt-4 text-xl md:text-3xl leading-tight font-heading font-bold md:font-normal text-heading'>CSE Student at MIET</h1>
                <h1 className='mb-4 text-xl md:text-3xl leading-tight font-heading font-bold md:font-normal text-heading'>Bringing a Holistic Approach to Web Development</h1>
